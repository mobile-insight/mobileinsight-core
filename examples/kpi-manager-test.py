...
def kpi_manager_example(path):
    ...
    # kpi_manager.enable_kpi("KPI.Accessibility.DEDICATED_BEARER_SR_QCI1_SUC", cell='22205186')
    ...
    # Test Mobility KPIs
    # kpi_manager.enable_kpi("KPI.Mobility.HO_TOTAL", periodicity='1h', cell='22205186')
    kpi_manager.enable_kpi("KPI.Mobility.HO_TOTAL", cell='22205186')
