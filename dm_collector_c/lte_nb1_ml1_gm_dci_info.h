...
const Fmt LteNb1SwGmDciInfoFmt[] = {
    {UINT, "Pkt Version", 1},
    {SKIP, NULL, 2} //Reserved
};

const Fmt LteNb1SwGmDciInfoFmt_v3[] = {
    {UINT, "Num of Records", 1}, 

};

const Fmt LteNb1SwGmDciInfoFmt_Record_v3[] = {
...
static int _decode_lte_nb1_ml1_gm_dci_info_payload (const char *b,
    ...
    case 3:
        {
            offset += _decode_by_fmt(LteNb1SwGmDciInfoFmt_v3,
                    ARRAY_SIZE(LteNb1SwGmDciInfoFmt_v3, Fmt),
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                offset += _decode_by_fmt(LteNb1SwGmDciInfoFmt_Record_v3,
                        ARRAY_SIZE(LteNb1SwGmDciInfoFmt_Record_v3, Fmt),
