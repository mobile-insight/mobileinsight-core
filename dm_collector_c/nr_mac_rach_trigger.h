...
const Fmt NrMacRachTriggerSubpkt_Fmt_samsung_v2_1[] = {
    //{UINT,"Sleep",        1},
    //{SKIP,NULL,           2},
    //{UINT,"DL Dynamic Cfg Change",1},
    //{UINT,"DL Config",    1},
                ...
                case 7:
			{
				...
				offset += _decode_by_fmt(NrMacRachTriggerSubpkt_Fmt_v2_1,
						...
						b, offset, length, result);
                               ...
                               {
				offset += _decode_by_fmt(NrMacRachTriggerSubpkt_Fmt_samsung_v2_1,
						ARRAY_SIZE(NrMacRachTriggerSubpkt_Fmt_samsung_v2_1, Fmt),
						b, offset, length, result);
                               }
                               else
                               {
