...
const Fmt GnssGlonass_Fmt [] = {
    {UINT, "Version", 1},
    {UINT, "FCount", 4},
    {UINT, "Glonass Cycle Number 4 Years", 1},
    {UINT, "Glonass Number of Days in 4 Years", 2},
    {UINT, "Glonass Milliseconds", 4},
    {UINT, "TimeBias", 4},
    {UINT, "ClkTimeUnc", 4},
    {UINT, "ClkFreqBias", 4},
    {UINT, "ClkFreqUnc", 4},
...
const Fmt GnssGlonassSv_Fmt [] = {
    {UINT, "SV", 1},
    {UINT,"FrqIdx",1},
    {UINT, "ObsState", 1},
    {UINT, "Tot", 1},
    {UINT, "Gd", 1},
    {BYTE_STREAM,"HammEM",1},
    {UINT, "FiltN", 1},
    {UINT, "CNo", 2},
...
static int _decode_gnss_glonass_payload (const char *b,
    ...
    for (int i = 0; i < numberSvs; i++) {
        ...
        offset += _decode_by_fmt(GnssGlonassSv_Fmt,
                ARRAY_SIZE(GnssGlonassSv_Fmt, Fmt),
                b, offset, length, result_record_item);

         temp= _search_result_int(result_record_item, "FrqIdx");
         if(temp>128){
             temp=temp-256;
             old_object = _replace_result_int(result_record_item, "FrqIdx", temp);
             Py_DECREF(old_object);
         }
